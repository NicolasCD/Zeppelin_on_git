...
# For git ##test Nicolas##
COPY id_rsa /root/.ssh/id_rsa
ENV ZEPPELIN_NOTEBOOK_DIR /zeppelin/notebook/Zeppelin
ENV ZEPPELIN_NOTEBOOK_STORAGE org.apache.zeppelin.notebook.repo.GitNotebookRepo
